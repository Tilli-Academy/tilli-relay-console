...
/**
 * <swaggerx-method-badge> — Colored HTTP method label (GET, POST, etc.)
 *
 * Uses CSS custom properties (--sx-method-*) for colors, supporting both
 * light and dark mode without :host-context().
 *
 * Usage:
 *   <swaggerx-method-badge method="get"></swaggerx-method-badge>
 *   <swaggerx-method-badge method="post" compact></swaggerx-method-badge>
 */
@customElement('swaggerx-method-badge')
export class SwaggerXMethodBadge extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-method-badge': SwaggerXMethodBadge;
  }
}
