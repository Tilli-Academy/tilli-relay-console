...
/**
 * <swaggerx-split-pane> — A resizable horizontal split view.
 *
 * Fires `ratio-change` with { ratio: number } when the divider is dragged.
 *
 * Usage:
 *   <swaggerx-split-pane ratio="0.25" min-ratio="0.1" max-ratio="0.5">
 *     <div slot="left">Sidebar</div>
 *     <div slot="right">Main content</div>
 *   </swaggerx-split-pane>
 */
@customElement('swaggerx-split-pane')
export class SwaggerXSplitPane extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-split-pane': SwaggerXSplitPane;
  }
}
