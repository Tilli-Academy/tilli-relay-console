...
/**
 * <swaggerx-body-editor> — Request body editor with CodeMirror.
 *
 * Fires:
 *   - `body-change` with { body: string }
 *   - `content-type-change` with { contentType: string }
 */
@customElement('swaggerx-body-editor')
export class SwaggerXBodyEditor extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-body-editor': SwaggerXBodyEditor;
  }
}
