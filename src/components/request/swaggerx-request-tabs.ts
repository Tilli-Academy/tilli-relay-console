...
import './swaggerx-params-editor.js';
import './swaggerx-headers-editor.js';
import './swaggerx-auth-editor.js';
import './swaggerx-body-editor.js';
...
/**
 * <swaggerx-request-tabs> — Tabbed interface: Params | Headers | Auth | Body.
 *
 * Wraps the individual editors in a tab layout and forwards events upward.
 */
@customElement('swaggerx-request-tabs')
export class SwaggerXRequestTabs extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-request-tabs': SwaggerXRequestTabs;
  }
}
