...
/**
 * <swaggerx-request-bar> — Method selector + URL display bar.
 *
 * Fires:
 ...
 */
@customElement('swaggerx-request-bar')
export class SwaggerXRequestBar extends LitElement {
    ...
    return html`
      <div class="bar">
        ...
        <button class="send-btn" @click=${this._send} ?disabled=${this.loading}>
          <swaggerx-icon name="send" size=${14}></swaggerx-icon>
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-request-bar': SwaggerXRequestBar;
  }
}
