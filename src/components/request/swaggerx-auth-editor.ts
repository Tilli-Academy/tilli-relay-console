...
/**
 * <swaggerx-auth-editor> — Auth configuration panel (Bearer, Basic, API Key).
 *
 * Fires `auth-change` with { auth: AuthConfig }.
 */
@customElement('swaggerx-auth-editor')
export class SwaggerXAuthEditor extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-auth-editor': SwaggerXAuthEditor;
  }
}
