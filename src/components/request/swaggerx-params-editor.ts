...
/**
 * <swaggerx-params-editor> — Edits path and query parameters for an endpoint.
 *
 * Pre-populates fields from the endpoint's parameter definitions.
 * Fires `param-change` with { name, value, paramIn } on input.
 */
@customElement('swaggerx-params-editor')
export class SwaggerXParamsEditor extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-params-editor': SwaggerXParamsEditor;
  }
}
