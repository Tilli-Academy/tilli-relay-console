...
import type { SwaggerXSpec, UIState, HistoryEntry, Environment, Endpoint, TagGroup, HttpMethod, AuthConfig, RequestState } from '../../core/types.js';
import type { KeyValuePair } from '../shared/swaggerx-key-value-editor.js';
import '../layout/swaggerx-header.js';
import '../layout/swaggerx-split-pane.js';
import '../layout/swaggerx-sidebar.js';
import '../layout/swaggerx-main.js';
import '../shared/swaggerx-loading.js';
import '../shared/swaggerx-empty-state.js';
import '../navigation/swaggerx-search.js';
import '../navigation/swaggerx-toc.js';
import '../navigation/swaggerx-tag-group.js';
import '../navigation/swaggerx-endpoint-item.js';
import '../endpoint/swaggerx-endpoint.js';
import '../history/swaggerx-history-list.js';
import '../env/swaggerx-env-selector.js';
import '../env/swaggerx-env-manager.js';

/**
 * <swaggerx-app> — Root component for SwaggerX.
 *
 ...
 *   <swaggerx-app spec-url="/openapi.yaml" theme="dark"></swaggerx-app>
 */
@customElement('swaggerx-app')
export class SwaggerXApp extends LitElement {
    ...
    if (this._loading) {
      return html`
        <div class="center-container">
          <swaggerx-loading size="large" message="Loading API specification..."></swaggerx-loading>
        </div>
      `;
    }
