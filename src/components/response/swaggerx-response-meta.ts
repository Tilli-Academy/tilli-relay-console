...
import './swaggerx-status-badge.js';

/**
 * <swaggerx-response-meta> — Status badge, response time, and response size.
 */
@customElement('swaggerx-response-meta')
export class SwaggerXResponseMeta extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-response-meta': SwaggerXResponseMeta;
  }
}
