...
/**
 * <swaggerx-response-body> — Displays response body with formatting.
 *
 * Features:
 ...
 *   - Copy button
 */
@customElement('swaggerx-response-body')
export class SwaggerXResponseBody extends LitElement {
    ...
    return html`
      <div class="body-toolbar">
        ...
        <div class="body-actions">
          ...
          <swaggerx-copy-button text=${formatted}></swaggerx-copy-button>
        </div>
      </div>
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-response-body': SwaggerXResponseBody;
  }
}
