...
/**
 * <rundocs-response-headers> — Displays response headers in a table.
 */
@customElement('rundocs-response-headers')
export class RunDocsResponseHeaders extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'rundocs-response-headers': RunDocsResponseHeaders;
  }
}
