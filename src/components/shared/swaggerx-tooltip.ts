...
/**
 * <swaggerx-tooltip> — Wraps content with a hover tooltip.
 *
 * Usage:
 *   <swaggerx-tooltip text="Copy to clipboard">
 *     <button>Copy</button>
 *   </swaggerx-tooltip>
 */
@customElement('swaggerx-tooltip')
export class SwaggerXTooltip extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-tooltip': SwaggerXTooltip;
  }
}
