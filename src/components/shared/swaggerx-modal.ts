...
/**
 * <swaggerx-modal> — A simple overlay modal dialog.
 *
 * Fires `modal-close` when closed via backdrop click, Escape, or close button.
 *
 * Usage:
 *   <swaggerx-modal .open=${true} heading="Edit Environment" @modal-close=${handler}>
 *     <p>Modal body content here</p>
 *   </swaggerx-modal>
 */
@customElement('swaggerx-modal')
export class SwaggerXModal extends LitElement {
