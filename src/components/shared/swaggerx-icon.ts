...
/**
 * <swaggerx-icon> — SVG icon component using Heroicons Outline 24x24.
 *
 * Usage:
 *   <swaggerx-icon name="search"></swaggerx-icon>
 *   <swaggerx-icon name="moon" size="20"></swaggerx-icon>
 */
@customElement('swaggerx-icon')
export class SwaggerXIcon extends LitElement {
