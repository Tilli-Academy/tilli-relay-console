...
/**
 * <rundocs-schema-property> — Renders a single schema property with
 * name, type, description, constraints, and nested children.
 *
 * Recursively renders child properties for objects/arrays.
 */
@customElement('rundocs-schema-property')
export class RunDocsSchemaProperty extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'rundocs-schema-property': RunDocsSchemaProperty;
  }
}
