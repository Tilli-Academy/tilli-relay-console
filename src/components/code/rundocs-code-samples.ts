...
/**
 * <rundocs-code-samples> — Tabbed code samples (cURL, JavaScript, Python, Node.js).
 */
@customElement('rundocs-code-samples')
export class RunDocsCodeSamples extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'rundocs-code-samples': RunDocsCodeSamples;
  }
}
