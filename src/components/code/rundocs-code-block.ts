...
/**
 * <rundocs-code-block> — Displays a code snippet with copy button.
 *
 * Supports syntax highlighting for: json, curl, javascript, nodejs, python.
 * Unsupported languages render as plain monospace text.
 */
@customElement('rundocs-code-block')
export class RunDocsCodeBlock extends LitElement {
  ...
  override render() {
    ...
    return html`
      <div class="code-header">
        ...
        <rundocs-copy-button text=${this.code}></rundocs-copy-button>
      </div>
      ${highlighted
...
declare global {
  interface HTMLElementTagNameMap {
    'rundocs-code-block': RunDocsCodeBlock;
  }
}
