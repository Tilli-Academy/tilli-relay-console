...
import './swaggerx-history-item.js';
import type { HistoryEntry } from '../../core/types.js';

/**
 * <swaggerx-history-list> — Displays a list of request history entries grouped by date.
 *
 ...
 *   - `history-clear`
 */
@customElement('swaggerx-history-list')
export class SwaggerXHistoryList extends LitElement {
    ...
    return html`
      <div class="header">
        ...
        <button class="clear-btn" @click=${this._onClear}>
          <swaggerx-icon name="trash" size=${12}></swaggerx-icon>
          Clear
        </button>
      </div>
      <div class="list">
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-history-list': SwaggerXHistoryList;
  }
}
