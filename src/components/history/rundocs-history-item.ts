...
/**
 * <rundocs-history-item> — A single history entry row.
 *
 * Fires:
 *   - `history-select` with { id }
 *   - `history-remove` with { id }
 */
@customElement('rundocs-history-item')
export class RunDocsHistoryItem extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'rundocs-history-item': RunDocsHistoryItem;
  }
}
