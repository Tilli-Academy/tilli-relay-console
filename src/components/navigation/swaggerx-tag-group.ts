...
/**
 * <swaggerx-tag-group> — Collapsible group of endpoints under a tag name.
 *
 * Usage:
 *   <swaggerx-tag-group name="pets" count="4">
 *     <swaggerx-endpoint-item ...></swaggerx-endpoint-item>
 *   </swaggerx-tag-group>
 */
@customElement('swaggerx-tag-group')
export class SwaggerXTagGroup extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-tag-group': SwaggerXTagGroup;
  }
}
