...
/**
 * <swaggerx-toc> — API overview section at the top of the sidebar.
 *
 * Shows API description, server URLs, and contact/license info.
 */
@customElement('swaggerx-toc')
export class SwaggerXToc extends LitElement {
