...
import '../endpoint/swaggerx-method-badge.js';

/**
 * <swaggerx-endpoint-item> — A single endpoint row in the sidebar.
 *
 * Fires `endpoint-select` with { endpointId: string } on click.
 */
@customElement('swaggerx-endpoint-item')
export class SwaggerXEndpointItem extends LitElement {
  ...
  override render() {
    return html`
      <button
        ...
        @click=${this._onClick}
      >
        <swaggerx-method-badge method=${this.method} compact></swaggerx-method-badge>
        <div class="text">
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-endpoint-item': SwaggerXEndpointItem;
  }
}
