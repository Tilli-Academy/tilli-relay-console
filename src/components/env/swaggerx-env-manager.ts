...
import '../shared/swaggerx-modal.js';
...
/**
 * <swaggerx-env-manager> — Modal for managing environments and variables.
 *
 * Fires:
 *   - `env-add` with { name }
 *   - `env-remove` with { id }
 ...
 *   - `env-close`
 */
@customElement('swaggerx-env-manager')
export class SwaggerXEnvManager extends LitElement {
  ...
  override render() {
    ...
    return html`
      <swaggerx-modal ?open=${this.open} heading="Manage Environments" @modal-close=${this._onClose}>
...
declare global {
  interface HTMLElementTagNameMap {
    'swaggerx-env-manager': SwaggerXEnvManager;
  }
}
