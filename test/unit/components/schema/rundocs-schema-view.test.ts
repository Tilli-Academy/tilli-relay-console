...
import '../../../../src/components/schema/rundocs-schema-view.js';
import type { RunDocsSchemaView } from '../../../../src/components/schema/rundocs-schema-view.js';
...
describe('rundocs-schema-view', () => {
  let el: RunDocsSchemaView;

  beforeEach(async () => {
    el = await fixture<RunDocsSchemaView>(html`
      <rundocs-schema-view .schema=${petSchema} title="Pet"></rundocs-schema-view>
    `);
  });
  ...
  it('renders schema properties by default', () => {
    const properties = el.shadowRoot!.querySelectorAll('rundocs-schema-property');
  ...
  it('handles empty schema', async () => {
    el = await fixture<RunDocsSchemaView>(html`
      <rundocs-schema-view .schema=${{}}></rundocs-schema-view>
    `);
