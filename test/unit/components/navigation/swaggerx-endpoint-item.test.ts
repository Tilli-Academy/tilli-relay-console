...
import '../../../../src/components/navigation/swaggerx-endpoint-item.js';
import type { SwaggerXEndpointItem } from '../../../../src/components/navigation/swaggerx-endpoint-item.js';

describe('swaggerx-endpoint-item', () => {
  let el: SwaggerXEndpointItem;

  beforeEach(async () => {
    el = await fixture<SwaggerXEndpointItem>(html`
