...
import '../../../../src/components/navigation/rundocs-search.js';
import type { RunDocsSearch } from '../../../../src/components/navigation/rundocs-search.js';

describe('rundocs-search', () => {
  let el: RunDocsSearch;

  beforeEach(async () => {
    el = await fixture<RunDocsSearch>(html`<rundocs-search></rundocs-search>`);
  });
  ...
  it('accepts custom placeholder', async () => {
    el = await fixture<RunDocsSearch>(html`
      <rundocs-search placeholder="Filter..."></rundocs-search>
    `);
    const input = el.shadowRoot!.querySelector('input') as HTMLInputElement;
