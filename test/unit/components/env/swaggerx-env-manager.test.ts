...
import '../../../../src/components/env/swaggerx-env-manager.js';
import type { SwaggerXEnvManager } from '../../../../src/components/env/swaggerx-env-manager.js';
...
describe('swaggerx-env-manager', () => {
  it('renders nothing when closed', async () => {
    const el = await fixture<SwaggerXEnvManager>(
      html`<swaggerx-env-manager></swaggerx-env-manager>`,
    );
    const modal = el.shadowRoot!.querySelector('swaggerx-modal');
    expect(modal).toBeNull();
  });

  it('renders modal when open', async () => {
    const el = await fixture<SwaggerXEnvManager>(
      html`<swaggerx-env-manager ?open=${true} .environments=${makeEnvs()}></swaggerx-env-manager>`,
    );
    const modal = el.shadowRoot!.querySelector('swaggerx-modal');
  ...
  it('shows add input and button', async () => {
    const el = await fixture<SwaggerXEnvManager>(
      html`<swaggerx-env-manager ?open=${true}></swaggerx-env-manager>`,
    );
  ...
  it('lists environments', async () => {
    const envs = makeEnvs();
    const el = await fixture<SwaggerXEnvManager>(
      html`<swaggerx-env-manager ?open=${true} .environments=${envs}></swaggerx-env-manager>`,
    );
