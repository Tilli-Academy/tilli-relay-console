...
import '../../../../src/components/env/rundocs-env-selector.js';
import type { RunDocsEnvSelector } from '../../../../src/components/env/rundocs-env-selector.js';
...
describe('rundocs-env-selector', () => {
  it('renders select element', async () => {
    const el = await fixture<RunDocsEnvSelector>(
      html`<rundocs-env-selector></rundocs-env-selector>`,
    );
  ...
  it('lists environments as options', async () => {
    const envs = makeEnvs();
    const el = await fixture<RunDocsEnvSelector>(
      html`<rundocs-env-selector .environments=${envs}></rundocs-env-selector>`,
    );
    const select = el.shadowRoot!.querySelector('.env-select') as HTMLSelectElement;
    const options = select.querySelectorAll('option');
