...
import '../../../../src/components/history/rundocs-history-list.js';
import type { RunDocsHistoryList } from '../../../../src/components/history/rundocs-history-list.js';
...
describe('rundocs-history-list', () => {
  it('shows empty state when no entries', async () => {
    const el = await fixture<RunDocsHistoryList>(
      html`<rundocs-history-list></rundocs-history-list>`,
    );
    const emptyState = el.shadowRoot!.querySelector('rundocs-empty-state');
  ...
  it('renders history items when entries exist', async () => {
    ...
    const el = await fixture<RunDocsHistoryList>(
      html`<rundocs-history-list .entries=${entries}></rundocs-history-list>`,
    );
    const items = el.shadowRoot!.querySelectorAll('rundocs-history-item');
