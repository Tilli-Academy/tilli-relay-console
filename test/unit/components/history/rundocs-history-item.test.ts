...
import '../../../../src/components/history/rundocs-history-item.js';
import type { RunDocsHistoryItem } from '../../../../src/components/history/rundocs-history-item.js';

describe('rundocs-history-item', () => {
  it('renders method and URL', async () => {
    const el = await fixture<RunDocsHistoryItem>(
      html`<rundocs-history-item
        historyId="test-1"
        method="get"
  ...
  it('fires history-select on click', async () => {
    const el = await fixture<RunDocsHistoryItem>(
      html`<rundocs-history-item historyId="test-1" method="get" url="/test" status=${200} timestamp=${0}></rundocs-history-item>`,
    );
  ...
  it('applies success class for 2xx status', async () => {
    const el = await fixture<RunDocsHistoryItem>(
      html`<rundocs-history-item historyId="t" method="get" url="/test" status=${200} timestamp=${0}></rundocs-history-item>`,
    );
    const status = el.shadowRoot!.querySelector('.status')!;
  ...
  it('applies error class for 5xx status', async () => {
    const el = await fixture<RunDocsHistoryItem>(
      html`<rundocs-history-item historyId="t" method="get" url="/test" status=${500} timestamp=${0}></rundocs-history-item>`,
    );
    const status = el.shadowRoot!.querySelector('.status')!;
