...
import '../../../../src/components/request/rundocs-auth-editor.js';
import type { RunDocsAuthEditor } from '../../../../src/components/request/rundocs-auth-editor.js';
import type { AuthConfig } from '../../../../src/core/types.js';

describe('rundocs-auth-editor', () => {
  it('renders auth type selector', async () => {
    const el = await fixture<RunDocsAuthEditor>(
      html`<rundocs-auth-editor></rundocs-auth-editor>`,
    );
  ...
  it('shows "No Auth" message for type=none', async () => {
    ...
    const el = await fixture<RunDocsAuthEditor>(
      html`<rundocs-auth-editor .auth=${auth}></rundocs-auth-editor>`,
    );
