...
import '../../../../src/components/request/swaggerx-params-editor.js';
import type { SwaggerXParamsEditor } from '../../../../src/components/request/swaggerx-params-editor.js';
import type { Parameter } from '../../../../src/core/types.js';

describe('swaggerx-params-editor', () => {
  it('shows empty state when no parameters', async () => {
    const el = await fixture<SwaggerXParamsEditor>(
      html`<swaggerx-params-editor></swaggerx-params-editor>`,
    );
  ...
  it('renders path parameters section', async () => {
    ...
    const el = await fixture<SwaggerXParamsEditor>(
      html`<swaggerx-params-editor .parameters=${params}></swaggerx-params-editor>`,
    );
