...
import '../../../../src/components/request/rundocs-body-editor.js';
import type { RunDocsBodyEditor } from '../../../../src/components/request/rundocs-body-editor.js';

describe('rundocs-body-editor', () => {
  it('renders CodeMirror editor', async () => {
    const el = await fixture<RunDocsBodyEditor>(
      html`<rundocs-body-editor></rundocs-body-editor>`,
    );
  ...
  it('displays initial body content', async () => {
    const el = await fixture<RunDocsBodyEditor>(
      html`<rundocs-body-editor body='{"key": "value"}'></rundocs-body-editor>`,
    );
    const wrapper = el.shadowRoot!.querySelector('.editor-wrapper')!;
  ...
  it('has line numbers', async () => {
    const el = await fixture<RunDocsBodyEditor>(
      html`<rundocs-body-editor body='{"a": 1}'></rundocs-body-editor>`,
    );
    const wrapper = el.shadowRoot!.querySelector('.editor-wrapper')!;
