...
import '../../../../src/components/response/swaggerx-response-body.js';
import type { SwaggerXResponseBody } from '../../../../src/components/response/swaggerx-response-body.js';

describe('swaggerx-response-body', () => {
  it('shows empty state when no body', async () => {
    const el = await fixture<SwaggerXResponseBody>(
      html`<swaggerx-response-body></swaggerx-response-body>`,
    );
  ...
  it('renders body content in CodeMirror', async () => {
    const el = await fixture<SwaggerXResponseBody>(
      html`<swaggerx-response-body body="Hello, World!"></swaggerx-response-body>`,
    );
  ...
  it('pretty-prints JSON body', async () => {
    ...
    const el = await fixture<SwaggerXResponseBody>(
      html`<swaggerx-response-body body=${json} content-type="application/json"></swaggerx-response-body>`,
    );
    const wrapper = el.shadowRoot!.querySelector('.body-content')!;
    const cmContent = wrapper.querySelector('.cm-content')!;
  ...
  it('shows raw body when JSON parsing fails', async () => {
    ...
    const el = await fixture<SwaggerXResponseBody>(
      html`<swaggerx-response-body body=${invalid} content-type="application/json"></swaggerx-response-body>`,
    );
    const wrapper = el.shadowRoot!.querySelector('.body-content')!;
    const cmContent = wrapper.querySelector('.cm-content')!;
  ...
  it('displays content type label', async () => {
    const el = await fixture<SwaggerXResponseBody>(
      html`<swaggerx-response-body body="data" content-type="text/html"></swaggerx-response-body>`,
    );
  ...
  it('shows copy button', async () => {
    const el = await fixture<SwaggerXResponseBody>(
      html`<swaggerx-response-body body="data"></swaggerx-response-body>`,
    );
