...
import '../../../../src/components/response/swaggerx-response-headers.js';
import type { SwaggerXResponseHeaders } from '../../../../src/components/response/swaggerx-response-headers.js';

describe('swaggerx-response-headers', () => {
  it('shows empty state when no headers', async () => {
    const el = await fixture<SwaggerXResponseHeaders>(
      html`<swaggerx-response-headers></swaggerx-response-headers>`,
    );
  ...
  it('renders headers in a table', async () => {
    ...
    const el = await fixture<SwaggerXResponseHeaders>(
      html`<swaggerx-response-headers .headers=${headers}></swaggerx-response-headers>`,
    );
