...
import '../../../../src/components/layout/swaggerx-sidebar.js';
import type { SwaggerXSidebar } from '../../../../src/components/layout/swaggerx-sidebar.js';

describe('swaggerx-sidebar', () => {
  it('renders two tab buttons', async () => {
    const el = await fixture<SwaggerXSidebar>(
      html`<swaggerx-sidebar></swaggerx-sidebar>`,
    );
  ...
  it('shows endpoints slot when active', async () => {
    const el = await fixture<SwaggerXSidebar>(
      html`<swaggerx-sidebar activePanel="endpoints"></swaggerx-sidebar>`,
    );
