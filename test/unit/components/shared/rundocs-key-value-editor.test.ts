...
import '../../../../src/components/shared/rundocs-key-value-editor.js';
import type { RunDocsKeyValueEditor, KeyValuePair } from '../../../../src/components/shared/rundocs-key-value-editor.js';
...
describe('rundocs-key-value-editor', () => {
  let el: RunDocsKeyValueEditor;

  beforeEach(async () => {
    el = await fixture<RunDocsKeyValueEditor>(html`
      <rundocs-key-value-editor .pairs=${[...samplePairs]}></rundocs-key-value-editor>
    `);
  });
  ...
  it('hides add/remove buttons in readonly mode', async () => {
    el = await fixture<RunDocsKeyValueEditor>(html`
      <rundocs-key-value-editor .pairs=${[...samplePairs]} readonly></rundocs-key-value-editor>
    `);
