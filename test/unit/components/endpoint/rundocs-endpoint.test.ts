...
import '../../../../src/components/endpoint/rundocs-endpoint.js';
import type { RunDocsEndpoint } from '../../../../src/components/endpoint/rundocs-endpoint.js';
...
describe('rundocs-endpoint', () => {
  let el: RunDocsEndpoint;

  beforeEach(async () => {
    el = await fixture<RunDocsEndpoint>(html`
      <rundocs-endpoint .endpoint=${sampleEndpoint}></rundocs-endpoint>
    `);
  });
  ...
  it('renders the path display', () => {
    const path = el.shadowRoot!.querySelector('rundocs-path-display');
  ...
  it('renders description', () => {
    const desc = el.shadowRoot!.querySelector('rundocs-description');
  ...
  it('renders response sections in responses doc tab', async () => {
    ...
    const tabs = el.shadowRoot!.querySelector('.docs-panel rundocs-tabs') as HTMLElement;
  ...
  it('renders schema view for responses with content', async () => {
    ...
    const schemaViews = el.shadowRoot!.querySelectorAll('rundocs-schema-view');
  ...
  it('renders tag badges in header', () => {
    ...
    const badges = headerTags!.querySelectorAll('rundocs-badge');
  ...
  it('shows deprecated badge in header', async () => {
    ...
    el = await fixture<RunDocsEndpoint>(html`
      <rundocs-endpoint .endpoint=${deprecatedEp}></rundocs-endpoint>
    `);
    const headerTags = el.shadowRoot!.querySelector('.header-tags');
    const badges = headerTags!.querySelectorAll('rundocs-badge');
  ...
  it('shows authenticated badge when security is set', async () => {
    ...
    el = await fixture<RunDocsEndpoint>(html`
      <rundocs-endpoint .endpoint=${securedEp}></rundocs-endpoint>
    `);
    const headerTags = el.shadowRoot!.querySelector('.header-tags');
    const badges = headerTags!.querySelectorAll('rundocs-badge');
